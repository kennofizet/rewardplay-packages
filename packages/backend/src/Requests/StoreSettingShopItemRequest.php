...
class StoreSettingShopItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'setting_item_id' => 'required|integer|exists:' . $itemTable . ',id',
            'event_id' => 'nullable|integer|exists:' . $eventTable . ',id',
            'category' => 'sometimes|string|in:' . $categories,
            'prices' => 'nullable|array',
            'prices.*.type' => 'required|string|in:' . $priceTypes,
            'prices.*.value' => 'nullable|numeric|min:0',
            'prices.*.item_id' => 'nullable|integer|exists:' . $itemTable . ',id',
