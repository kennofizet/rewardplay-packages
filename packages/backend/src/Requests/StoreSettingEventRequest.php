...
class StoreSettingEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'daily_reward_bonus.*.rewards.*.item_id' => 'nullable|integer|exists:' . (new \Kennofizet\RewardPlay\Models\SettingItem())->getTable() . ',id',
            'is_active' => 'sometimes|boolean',
            'item_ids' => 'nullable|array',
            'item_ids.*' => 'integer|exists:' . (new \Kennofizet\RewardPlay\Models\SettingItem())->getTable() . ',id',
        ];
    }
}
