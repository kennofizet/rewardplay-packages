...
/**
 * User Model Relationship Settings
 * 
 ...
 */
class UserRelationshipSetting
{
    /**
     * Relationship settings by mode
     */
    protected static $settings = [
        UserConstant::API_USER_LIST_PAGE => [
        ],
     ...
     */
    public static function buildWithCountArray(?string $mode = null, $user = null): array
    {
        $mode = $mode ?? UserModelResponse::getAvailableModeDefault();
