...
/**
 * SettingDailyReward Model Relationship Settings
 * 
 ...
 */
class SettingDailyRewardRelationshipSetting
{
    /**
     ...
     */
    public static function buildWithCountArray(?string $mode = null, $settingDailyReward = null): array
    {
        $mode = $mode ?? SettingDailyRewardModelResponse::getAvailableModeDefault();
